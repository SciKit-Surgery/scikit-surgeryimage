...
def test_undistort_4_1_1_26():
    ...
    np.testing.assert_array_equal(undistorted, expected_undistorted_4_1_1_26)


if __name__ == "__main__":
   
    try:
        test_undistort_4_1_0_25()
    except AssertionError:
        print ('test_undistort_4_1_0_25 FAILED')

    try:
        test_undistort_4_1_1_26()
    except AssertionError:
        print ('test_undistort_4_1_1_26 FAILED')
