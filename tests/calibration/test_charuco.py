...
def test_detect_charuco_points_with_png_files():
    ...
    image = cv2.imread('tests/data/calibration/pattern_4x4_19x26_5_4_with_inset_13x18-landscape.png')
    marker_corners, marker_ids, \
        chessboard_corners, chessboard_ids \
    ...
    image = cv2.imread('tests/data/calibration/pattern_4x4_19x26_5_4_with_inset_13x18_corrupted1-landscape.png')
    marker_corners, marker_ids, \
        chessboard_corners, chessboard_ids \
        = charuco.detect_charuco_points(dictionary, board, image, filtering=True)
